...
void APP_Tasks(void) {
    ...
    switch (appData.state) {
        ...
        case APP_STATE_SCHEDULE_WRITE:
            ...
            rawdata[i%WINDOWLEN] = accelZ;
            firval = fir(rawdata, i);
            mirval = mir(rawdata);
            irrval = (ALPHA*accelZ + BETA*irrval)/SCALE;
            /* Setup the write */
            ...
            len = sprintf(dataOut, "%d, %d, %d, %d\r\n", rawdata[i%WINDOWLEN], mirval, firval, irrval); //data in format: original, MIR filtered, FIR Filtered, IRR Filtered
            i++; 
